...
export class Migrations1693328897530 implements MigrationInterface {
    name = 'Migrations1693328897530'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "car_user_comments" ("id" SERIAL NOT NULL, "comment" character varying NOT NULL, "register_date" TIMESTAMP NOT NULL DEFAULT now(), "carId" integer, "userId" integer, CONSTRAINT "PK_131f91a9a5acb1e2669ec28a4f8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_account_state_enum" AS ENUM('buyer', 'seller')`);
