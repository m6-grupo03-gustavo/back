...
const createCommentService = (data, userId, carId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const newComment = commentRepository.create(Object.assign(Object.assign({}, data), { user: { id: userId }, car: { id: carId } }));
    yield commentRepository.save(newComment);
    const loadedCommentCar = yield commentRepository
